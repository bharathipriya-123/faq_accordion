...
//     const [visibleIndex,setVissibleIndex]=useState(null);
...
//             answer:"What is the hardest natural substance on Earth?."
//         },
//     ];
//     const answers =(index) =>
//     {
//         setVissibleIndex(visibleIndex === index ? null : index);
//     }
//   return (
//     <div>
//        <h1>FAQ SECTION</h1>
//         {faqs.map((faq,index)=>(
//             <div key={index}>
//               <button onClick={()=>answers(index)}>{faq.question}</button>
//               {visibleIndex === index && <p>{faq.answer}</p>}
//             </div>
//         ))}
//     </div>
//   )
